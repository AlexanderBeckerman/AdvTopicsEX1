...
private:
    ...
    Logger() : currentLevel_(Level::INFO), currentFile_(__FILE__), currentLine_(__LINE__) {}
...
#define LOG(level) Logger::getInstance().set(Logger::Level::level, __FILE__, __LINE__)
