...
// #include "../smarter_algorithm/SDFS.h"
// #include <gtest/gtest.h>

// class SDFSTest : public ::testing::Test {
//   protected:
//     MySimulator *sim;
...
// TEST_F(SDFSTest, didntChargeFullBatteryTestB) {
//     Robot r = Robot(getConfig(*sim));
//     B_209639780_207011180 algo;
...
//                      battery_before_step ==
//                      r.getBatterySensor().getCapacity());
//     }
// }

// TEST_F(SDFSTest, didntStayOnCleanTileTestB) {
//     Robot r = Robot(getConfig(*sim));
//     B_209639780_207011180 algo;
...
// TEST_F(SDFSTest, didntMoveIntoWallTestB) {
...
// TEST_F(SDFSTest, didntGetStuckTestB) {
//     Robot r = Robot(getConfig(*sim));
//     B_209639780_207011180 algo;
//     algo.setWallsSensor(r.getWallSensor());
//     algo.setDirtSensor(r.getDirtSensor());
...
// TEST_F(SDFSTest, testInputSuccessB) {
//     B_209639780_207011180 algo;
//     sim->setAlgorithm(algo);
//     sim->run();
...
// TEST_F(SDFSTest, impossibleCleanFinishedAtDockB) {
//     B_209639780_207011180 algo;
//     MySimulator sim;
